...
These ADRs record the MVP decisions listed in [`docs/spec/spec.md`](../spec/spec.md) §51.
...
| [ADR-006](./006-canonical-versioned-json-format.md) | Canonical versioned JSON format | Accepted |
| [ADR-007](./007-rls-based-user-isolation.md) | RLS-based tenant/user isolation | Accepted |
| [ADR-008](./008-ai-features-deferred-from-mvp.md) | AI features deferred from MVP | Accepted |
