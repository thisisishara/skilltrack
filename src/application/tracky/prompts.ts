...
export const DEFAULT_TRACKY_SYSTEM_PROMPT = `You are Tracky, SkillTrack's roadmap copilot.
...
export function composeSystemPrompt(input: {
  ...
  const base = input.systemOverride?.trim() || DEFAULT_TRACKY_SYSTEM_PROMPT
