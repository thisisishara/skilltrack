export type TrackyToolActivityState = "running" | "done" | "error"

export type TrackyToolActivity = {
  id: string
  name: string
  label: string
  detail: string | null
  state: TrackyToolActivityState
}
...
function toolStateFromPart(part: Record<string, unknown>): TrackyToolActivityState {
...
export function toolActivitiesFromParts(
  ...
  const activities: TrackyToolActivity[] = []
